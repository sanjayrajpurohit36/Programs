...
/*
 Here, the third promise which will settle in 1 second, is rejected, even though it will wait for the next 
 promise to fulfill so that it can return the result of the first fulfilled promise.
 After 2 seconds promise 2 will get resolved so, it will return the result of the second promise
*/
